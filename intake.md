...
2. Go / reframe / kill decision with reasoning
3. Module list declared
4. Interaction model defined
5. Initial timeline proposed
6. Project entry created in PROJECTS.md
7. New project repo spun up with only declared modules
